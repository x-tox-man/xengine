...
private:
    ...
    void SortAdjacentTriangles(int vIndex, std::set<VETManifoldMesh::Triangle*> const& tAdj,
        std::vector<VETManifoldMesh::Triangle*>& tAdjSorted);
    ...
    std::map<VETManifoldMesh::Triangle*, int> mTriToNormal;
...
template <typename Real>
void ExtremalQuery3BSP<Real>::SortAdjacentTriangles(int vIndex, std::set<VETManifoldMesh::Triangle*> const& tAdj,
    std::vector<VETManifoldMesh::Triangle*>& tAdjSorted)
{
