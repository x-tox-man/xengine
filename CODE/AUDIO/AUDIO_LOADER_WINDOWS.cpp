...
AUDIO_LOADER_WINDOWS::AUDIO_LOADER_WINDOWS()
{
}
 ...
 */
HRESULT AUDIO_LOADER_WINDOWS::OpenFromFile( TCHAR* inputFileName ) {
    // Open the mp3 file
 ...
 */
HRESULT AUDIO_LOADER_WINDOWS::OpenFromMemory( BYTE* mp3InputBuffer, DWORD mp3InputBufferSize ) {
 ...
 */
void AUDIO_LOADER_WINDOWS::Close() {
 ...
 */
double AUDIO_LOADER_WINDOWS::GetDuration() {
 ...
 */
double AUDIO_LOADER_WINDOWS::GetPosition() {
 ...
 */
void AUDIO_LOADER_WINDOWS::Play() {
