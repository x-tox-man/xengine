...
public : \
    ...
    friend class XS_CLASS_SERIALIZER< __CLASS_NAME__, CORE_JSON_STREAM >; \
...
#define XS_DEFINE_SERIALIZABLE \
    public : \
        ...
        void Serialize( CORE_JSON_STREAM & stream ); \
        void UnSerialize( CORE_JSON_STREAM & stream ); \
