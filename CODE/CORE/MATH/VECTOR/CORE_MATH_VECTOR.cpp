...
CORE_ABSTRACT_PROGRAM_BINDER_DECLARE_CLASS( CORE_MATH_VECTOR )
    /*CORE_ABSTRACT_PROGRAM_BINDER_DEFINE_YIELD_METHOD( float , CORE_MATH_VECTOR, X )
    CORE_ABSTRACT_PROGRAM_BINDER_DEFINE_YIELD_METHOD( float , CORE_MATH_VECTOR, Y )
    CORE_ABSTRACT_PROGRAM_BINDER_DEFINE_YIELD_METHOD( float , CORE_MATH_VECTOR, Z )
    CORE_ABSTRACT_PROGRAM_BINDER_DEFINE_YIELD_METHOD( float , CORE_MATH_VECTOR, W )*/
