...
XS_CLASS_BEGIN( GAMEPLAY_CHECKPOINT_SYSTEM )
    ...
    inline void SetPlayerPlayerHitCallback( CORE_HELPERS_CALLBACK_2< GAMEPLAY_COMPONENT_ENTITY *, GAMEPLAY_COMPONENT_ENTITY * > & callback ) { PlayerHitCallback = callback; }
