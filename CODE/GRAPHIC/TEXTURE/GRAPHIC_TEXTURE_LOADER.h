...
XS_CLASS_BEGIN_WITH_ANCESTOR(GRAPHIC_TEXTURE_LOADER, GRAPHIC_TEXTURE_ANCESTOR_LOADER_TYPE )
    ...
    virtual GRAPHIC_TEXTURE * Load( const CORE_FILESYSTEM_PATH & file,const CORE_HELPERS_UNIQUE_IDENTIFIER & identifier = CORE_HELPERS_UNIQUE_IDENTIFIER::Empty );


    virtual GRAPHIC_TEXTURE * Load( CORE_DATA_STREAM & stream ,const CORE_HELPERS_UNIQUE_IDENTIFIER & identifier = CORE_HELPERS_UNIQUE_IDENTIFIER::Empty);
