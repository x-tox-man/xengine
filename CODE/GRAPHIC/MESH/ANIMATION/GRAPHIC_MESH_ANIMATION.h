...
class GRAPHIC_MESH_ANIMATION_RESOURCE_LOADER;
class GRAPHIC_MESH_ANIMATION;

typedef RESOURCE< GRAPHIC_MESH_ANIMATION, GRAPHIC_MESH_ANIMATION_RESOURCE_LOADER > GR_A_GRAPHIC_ANIMATION_ANCESTOR_TYPE;

XS_CLASS_BEGIN_WITH_ANCESTOR_WITH_COPY( GRAPHIC_MESH_ANIMATION, GR_A_GRAPHIC_ANIMATION_ANCESTOR_TYPE )
    ...
    CORE_HELPERS_FACTORY_Element( GRAPHIC_MESH_ANIMATION, BASE_RESOURCE, RESOURCE_TYPE, RESOURCE_TYPE_ModelAnimation )
