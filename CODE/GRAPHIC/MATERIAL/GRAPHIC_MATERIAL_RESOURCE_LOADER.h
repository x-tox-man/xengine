...
XS_CLASS_BEGIN_WITH_ANCESTOR(GRAPHIC_MATERIAL_RESOURCE_LOADER, GRAPHIC_MATERIAL_ANCESTOR_LOADER_TYPE )
    ...
    virtual GRAPHIC_MATERIAL * Load( const CORE_FILESYSTEM_PATH & file, int resource_load_flag = 0, const CORE_HELPERS_UNIQUE_IDENTIFIER & identifier = CORE_HELPERS_UNIQUE_IDENTIFIER::Empty );


    virtual GRAPHIC_MATERIAL * Load( CORE_DATA_STREAM & stream, int resource_load_flag = 0, const CORE_HELPERS_UNIQUE_IDENTIFIER & identifier = CORE_HELPERS_UNIQUE_IDENTIFIER::Empty);
