...
XS_CLASS_BEGIN_WITH_ANCESTOR( NETWORK_BROWSER_PRESENTER, GRAPHIC_UI_PRESENTER)
    ...
    void OnStartLobbyButtonPressed( GRAPHIC_UI_ELEMENT * clicked_element, GRAPHIC_UI_ELEMENT_STATE event );
