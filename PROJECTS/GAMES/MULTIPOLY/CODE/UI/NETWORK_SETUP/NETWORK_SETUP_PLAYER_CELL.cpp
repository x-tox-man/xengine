...
void NETWORK_SETUP_PLAYER_CELL::Initialize() {
    ...
    default_render_style->SetShape( GLOBAL_RESOURCES::GetInstance().TexturedPlanObject );
    default_render_style->SetTextureBlock( GLOBAL_RESOURCES::CreateTextureBlockFromImagePath( "player" ) );
...
void NETWORK_SETUP_PLAYER_CELL::SetPlayerInfo(NETWORK_PLAYER * info) {
    ...
    PlayerInfo = info;
    PlayerInfo->InitializeObservable();
