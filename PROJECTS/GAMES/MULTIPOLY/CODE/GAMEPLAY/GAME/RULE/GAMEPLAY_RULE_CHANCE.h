...
XS_CLASS_BEGIN_WITH_ANCESTOR_2( GAMEPLAY_RULE_CHANCE, GAMEPLAY_RULE, GAMEPLAY_ACTION )

    GAMEPLAY_RULE_CHANCE();
    virtual ~GAMEPLAY_RULE_CHANCE();
    ...
    CORE_HELPERS_FACTORY_Element( GAMEPLAY_RULE_CHANCE, GAMEPLAY_ACTION, GAMEPLAY_ACTION_TYPE, GAMEPLAY_ACTION_TYPE_Custom_12 )
