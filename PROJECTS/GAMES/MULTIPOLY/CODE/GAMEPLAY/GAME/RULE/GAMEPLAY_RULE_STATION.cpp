...
XS_IMPLEMENT_INTERNAL_MEMORY_LAYOUT( GAMEPLAY_RULE_STATION )

XS_END_INTERNAL_MEMORY_LAYOUT

ImplementTrickFroSerializeation(GAMEPLAY_RULE_STATION, GAMEPLAY_ACTION_TYPE_Custom_14 )
...
void GAMEPLAY_RULE_STATION::Apply() {
