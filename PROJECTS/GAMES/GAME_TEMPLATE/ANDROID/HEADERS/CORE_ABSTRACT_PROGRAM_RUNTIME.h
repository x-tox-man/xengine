...
XS_CLASS_BEGIN_WITH_ANCESTOR(CORE_ABSTRACT_PROGRAM_RUNTIME, CORE_ABSTRACT_BASE_PROGRAM_RUNTIME)


CORE_ABSTRACT_PROGRAM_RUNTIME() : CORE_ABSTRACT_BASE_PROGRAM_RUNTIME() {
