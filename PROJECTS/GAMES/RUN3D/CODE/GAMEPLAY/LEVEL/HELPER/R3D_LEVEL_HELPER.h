...
XS_CLASS_BEGIN( R3D_LEVEL_HELPER )
    ...
    static void DeactivateCheckpoint( GAMEPLAY_CHECKPOINT_SYSTEM & system, GAMEPLAY_COMPONENT_ENTITY::PTR checkpoint );
    static void ActivateNextCheckpoint( GAMEPLAY_CHECKPOINT_SYSTEM & system, GAMEPLAY_COMPONENT_ENTITY::PTR checkpoint );
